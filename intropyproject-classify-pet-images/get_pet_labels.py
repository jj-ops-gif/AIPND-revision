...
def get_pet_labels(image_dir):
  ...
  # filenames = ["beagle_0239.jpg", "Boston_terrier_02259.jpg", "beagle_0239.jpg"]
  # filenames = filename_list
  # pet_labels = ["beagle", "boston terrier", "ggg"]
  for idx in range(0, len(filename_list), 1):
    pet_name = get_label(filename_list[idx])
